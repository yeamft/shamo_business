...
const FolderKanban = createLucideIcon("folder-kanban", __iconNode$o);
const __iconNode$n = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const LockKeyhole = createLucideIcon("lock-keyhole", __iconNode$j);
const __iconNode$i = [
...
const MessageSquareMore = createLucideIcon("message-square-more", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
...
const ThumbsUp = createLucideIcon("thumbs-up", __iconNode$6);
const __iconNode$5 = [
